...
const Signup = () => {
    ...
    // function to handle form submit uisng axios
                    ...
                    <form class="space-y-4 md:space-y-6" action="#" onSubmit={handleFormSubmit}>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label htmlFor="terms" class="font-light text-gray-500 dark:text-gray-300">I accept the <a href="/" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Terms and Conditions</a></label>
                            </div>
                        </div>
